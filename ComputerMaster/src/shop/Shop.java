...
public class Shop< T extends PersonalComputer> {
    ...
    private LinkedHashMap< String, HashMap<T,Integer>> range ;
    ...
    public void buyComputer (T computer) {
        ...
        if (range.containsKey(computer.getClass().getName())) {
            ...
            HashMap<T, Integer> device = new HashMap();
    ...
    public void buyComputer (String type) {
        range.put(type, new HashMap<T,Integer>());
    }
    ...
    public HashMap<T, Integer> getTypedEquipment(String type) {
        ...
        for ( Map.Entry<String, HashMap<T, Integer>> list : range.entrySet()) {
    ...
    public Set<String> getTechniqueTypes () {
        return range.keySet();
