...
public class Table <T extends Pane, O extends Shop, C extends PersonalComputer> {
    ...
    private TableColumn createObjectColumn(Object object, Field field, String name, int columnIndex) throws IllegalAccessException {
        ...
        if (object != null) {
            ...
            buttonCol.setId(field.getDeclaringClass().toString());
                            ...
                            if (!pane.isVisible()) {
                                try {
                                    ...
                                    Object gadget = getGadget(selectedType,
                                            rootTable.getItems().get(getIndex()).get(rangeIdentifierColumnIndex).getValueSafe()); // аааааааааааааааааааа
                                    ...
                                    if (classField == (null)) {
                                        ...
                                        tableIn = new Table(pane, shopData, getIndex(), rootTable, selectedType, "", rangeIdentifierColumnIndex);
                                    } else {

                                        tableIn = new Table(pane, shopData, getIndex(), rootTable, selectedType,
                                        ...
                                        if (classField.getClass().getName().contains("util") ||
                                            ...
                                            if (classField.getClass().getTypeName().contains(HashMap.class.getTypeName())) {
                                                tableIn.addColumnCollection(pane.getPrefWidth(), pane.getPrefHeight(), (HashMap) classField, columnField[0]);
    ...
    private void addColumnCollection(double weight, double height, HashMap hashMap, Field field) throws IllegalAccessException {
        ...
        String f = hashMap.getClass().getPackageName();
    ...
    private void generateAlert(Alert.AlertType type, String text) {
        ...
        try {
            ...
            add.invoke(shopData, selectedType, "NewGadget");
            table.getColumns().clear();
            table.getItems().clear();
            createMainTableColumns();
            createMainTableItems(table);
    ...
    private void editCell1(TableColumn<ObservableList<StringProperty>, String> column) {
        ...
        column.setOnEditStart( editStart -> {
            ...
            if (weTryAddGadget &&
                  !rootTable.getColumns().get(rangeIdentifierColumnIndex).getCellData(rootIndex).equals("NewGadget")) {
        ...
        column.setOnEditCommit(cellEditEvent -> {
           ...
           try {
                if (table.equals(rootTable)) rootIndex = cellEditEvent.getTablePosition().getRow();
                            ...
                            if (field.getType().getName().contains("util") ^ field.getName().contains("lang")) {
                                ...
                                if (cellEditEvent.getTableView().getId().equals(field.getName()) &&
                                    ...
                                    if (field.getType().getName().replaceFirst("class", "").
                                        ...
                                        Method valueOf = clazz.getDeclaredMethod("valueOf",Object.class);
                                    ...
                                    if (field.getType().getName().replaceFirst("class", "").
                                        ...
                                        Method valueOf = clazzValue.getDeclaredMethod("valueOf",Object.class);
                                        valueOf.setAccessible(true);


                                        if ( columnIndex == 0 ) {

                                            Method valueOfKey = clazzValue.getDeclaredMethod("valueOf",Object.class);
                                        ...
                                        else hashMap.replace(hashMap.keySet().toArray()[cellIndex],valueOf.invoke(clazzValue,cellEditEvent.getNewValue()));
                                    }
    ...
    void addNewGadget() throws IllegalAccessException, InvocationTargetException, NoSuchMethodException, ClassNotFoundException, InstantiationException {
        ...
        add.invoke(shopData, aClass.getDeclaredConstructor(params).newInstance("NewGadget"), selectedType);
        weTryAddGadget = true;
    }
    ...
    void selectItem(String name) {
        ...
        for (; i < table.getItems().size(); i++) {
            if (table.getItems().get(i).get(rangeIdentifierColumnIndex).getValue().equals("NewGadget")) break;
        }
